...
Figure \ref{fig:archigh} shows the high level block diagram of our design.
...
As can be seen in the figure \ref{fig:lowarch}, first the input data consisting of the stereo images, the ground truth disparity and 
