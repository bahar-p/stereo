...
Figure \ref{fig:AR} illustrates the key components of a high level design we propose for a stereoscopic AR system.

\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{AR}
\caption{Proposed design of the high-level architecture of a stereoscopic AR system}
\label{fig:AR}
\end{figure} 
