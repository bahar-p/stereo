...
Figure \ref{fig:AR} illustrates a high level architecture of an AR system with its key components and some of their attributes.
...
Figure \ref{fig:architecture} shows the block diagram of our design.
...
the calibration data is passed to the system.
...
for the ground truth disparity and the disparity generated by the algorithm in equation \ref{eq:dispeq}, and then is compared to the relative 
