...
Sample stereo images taken using two regular webcams are displayed in Figure \ref{fig:unrect} and \ref{fig:rect},
...
\caption{Gaussian filter with kernel size of 5px}
\label{fig:gauss}
\end{figure} 
...
The dilation and erosion operations are illustrated in Figure \ref{fig:dilate} and \ref{fig:erode}, respectively.
...
\caption{Dilation of the detected edges in an image with a 10x10 structuring element}
\label{fig:edgedil}
\end{figure} 

Next chapter will describe the key concepts in the human visual system and its perception of the depth.
