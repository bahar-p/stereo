...
maps are kept constant over all the images in the dataset. These parameters are presented in Table \ref{tab:sgbmparams} and \ref{tab:adcparams} 
...
over the masked areas are displayed in Figure \ref{fig:imgmsk5} and \ref{fig:imgfull5}, respectively.
...
are presented in Table \ref{tab:outlmsk} and \ref{tab:outlfull} for each age group. For simplicity, we have labelled the valid pixels
...
and only a few average values have slightly changed. We have marked a few of these values with a blue circle in Figure \ref{fig:adcmnoLR} and \ref{fig:adcfnoLR}.
...
Comparing these results to the ones presented in Table \ref{tab:outlmsk}, \ref{tab:outlfull}, and \ref{tab:avgerr} a slight decrease in the amount of errors and 
