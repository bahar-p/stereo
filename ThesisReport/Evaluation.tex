...
are shown in Figure \ref{fig:midburydisps}, which nearly resemble the results published in the paper \cite{mei11}; therefore, we can
...
\begin{figure}[H]
\centering
\subcaptionbox{Tsukuba disparity image}
[.5\linewidth]{\includegraphics[scale=0.5]{tsukubadisp}}%
\subcaptionbox{Venus disparity image}
[.5\linewidth]{\includegraphics[scale=0.51]{venusdisp}}%
\caption{Disparity images generated by ADCensusB for Middlebury images in Figure \protect\ref{fig:midburyimgs}}
