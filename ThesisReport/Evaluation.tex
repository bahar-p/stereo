...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{adcenmsk3NoLRmrk}
\caption{Average disparity error for the masked regions - not refined}
\label{fig:adcmnoLR}
\end{figure} 
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{adcenmsk3mrk}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{adcenfull3NoLRmrk}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{adcenfull3mrk}
