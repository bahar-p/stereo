...
int costAD_caller(const cv::gpu::PtrStepSz<uchar3>&, const cv::gpu::PtrStepSz<uchar3>&, const cv::gpu::PtrStepSz<double>&, int d_idx, bool r_disp=false);
...
void findOutliers(cv::Mat, cv::Mat, cv::Mat&, float, float);
void reset();
